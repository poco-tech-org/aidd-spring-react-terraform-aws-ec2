...
レクチャーID: sec-03-lec-03
目的: PostgreSQLへの接続と再現可能なスキーマ変更を実装する
...
- `backend/src/main/java/com/pocotech/aidd/task/TaskRepository.java` — Spring Boot設定・コードの目安
- `backend/src/main/resources/db/migration/V1__create_tasks.sql` — 関連成果物の目安
- `backend/src/main/resources/application-local.yml` — Spring Boot設定・コードの目安
